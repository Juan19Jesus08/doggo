             ...
             <div class="carousel-3items owl-carousel owl-theme col-md-12">
                ...
                <div class="blog-box">
                   ...
                   <div class="blog-box-caption">
                      <!-- date -->
                      <div class="date"><span class="day">06</span><span class="month">Enero</span></div>
                      <a href="blog-single.php">
                         <h4>Salamanca, Gto</h4>
                      </a>
                      <!-- /link -->
                      <p>
                         Estaremos vendiendo en el jardín lazaro cardenas en la colonia bellavista y entregando sus pedidos. habra muchas sorpresas y nuevos productos vengan los esperamos avisenle a sus familiares y vecinos!!
                      </p>
                   </div>
                   <!-- blog-box-footer -->
