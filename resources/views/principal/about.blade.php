         ...
         <div class="accordion mt-5">
            ...
            <div class="card">
               ...
               <div id="collapseOne" class="collapse show" data-parent=".accordion">
                  <div class="card-body">
                     <p>Contribuir en el bienestar y salud de las mascotas, además de la satisfacción de las personas que las quieren, brindando productos y servicios que ayuden a proteger y mejorar la vida de las mascotas.</p>
                  </div>
               </div>
            </div>
            <!-- /card -->
            ...
            <div class="card">
               ...
               <div id="collapseTwo" class="collapse" data-parent=".accordion">
                  <div class="card-body">
                     <p>Ser una empresa lider en servicio de alimentación para mascotas con productos que beneficien la salud
                        además de ir contando con diferentes servicios en distintas gamas del sector de alimentación.</p>
                  </div>
               </div>
            </div>
            <!-- /card -->
                  ...
                  <div class="card-body">
                     <ul>
                        <li>Responsabilidad: Un valor fundamental dentro de la estructura de la empresa ya que tenemos el compromiso con cada uno
                            de nuestros clientes y sus mascotas por lo que debemos tomar una responsabilidad.</li>
                            <li>Amor: Para poder servir a nuestros doggo amigos y clientes es necesario sentir esa pasión y sentimiento de servicio hacia ellos con la finalidad de poder lograr ofrecerles calidad en nuestros productos y servicios.</li>
                            <li>Respeto: Valor esencial para lograr mantener un ambiente laboral sano y en el cual todos los colaboradores podamos tener una convencia sana.</li>
